...
// double lap(int dim, double *assigncost, int *rowsol, int *colsol, double *u, double *v);
...

{
  ...
  // free = (int *) malloc(dim * sizeof(int));      // list of unassigned rows.
  int free[dim];  // list of unassigned rows.
  // collist = (int *) malloc(dim * sizeof(int));    // list of columns to be scanned in various ways.
  int collist[dim];
  // matches = (int *) malloc(dim * sizeof(int));    // counts how many times a row could be assigned.
  int matches[dim];
  // d = (double *) malloc(dim * sizeof(double));         // 'cost-distance' in augmenting path calculation.
  double d[dim];
  // pred = (int *) malloc(dim * sizeof(int));       // row-predecessor of column in augmenting/alternating path.
  int pred[dim];
